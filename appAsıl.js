          ...
          <div class="card-body">
            ...
            <div class="offcanvas offcanvas-top " style="height: 800px" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
              ...
              <table class="table card-title" >               
                   ...
                   <td class="table-active">${paymentDay.value}</td>
                   </tr>                                                                         
               ...
               <div class="grid d-md-block">
                  <button class="btn btn-success m-5" type="button">Güncelle</button>
                  <button class="btn btn-danger m-5" type="button">Öğrenci Sil</button>
              </div>
